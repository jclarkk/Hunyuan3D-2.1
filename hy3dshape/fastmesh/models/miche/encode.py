...
from fastmesh.models.miche.michelangelo.utils.misc import instantiate_from_config
...
def load_model(ckpt_path="hy3dshape/fastmesh/models/miche/checkpoints/aligned_shape_latents/shapevae-256.ckpt"):
    model_config = OmegaConf.load("hy3dshape/fastmesh/models/miche/configs/aligned_shape_latents/shapevae-256.yaml")
